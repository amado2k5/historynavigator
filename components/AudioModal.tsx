            ...
            const loadAudioExperience = async () => {
                ...
                try {
                    ...
                    const imagePrompt = isKidsMode
                        ...
                        : `An atmospheric scene visualizing the historical event: "${event.title}" from the ${civilizationName} civilization, to accompany an audio narration. Style: detailed, cinematic, high-quality, photorealistic.`;
