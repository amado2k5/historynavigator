...
export const GlobeIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2h10a2 2 0 002-2v-1a2 2 0 012-2h1.945M7.7 9.3l.16-.295A2 2 0 019.854 8h4.292a2 2 0 011.994 1.005l.16.295M12 21a9 9 0 100-18 9 9 0 000 18z" />
    </svg>
);
...
export const MapIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13v-6m0-7v6m0 0l6-3m-6 3l6 3m-6-3V7m6 10l5.447 2.724A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13v-6m0 0l-6-3" />
    </svg>
);
...
export const AppleIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path d="M17.46.36c-1.35-.01-2.9.74-3.85 2.03-.9-.98-2.14-1.93-3.65-1.9-1.8.07-3.46.94-4.47 2.45-1.9 2.8.1 6.88 1.63 9.17.84 1.25 1.93 2.6 3.28 2.57 1.32-.04 1.75-.8 3.28-.8s1.95.77 3.28.77c1.35.03 2.33-1.28 3.15-2.5 1.02-1.52 1.5-3.08 1.54-3.15-.04-.01-3.1-1.2-3.15-4.87.03-2.35 1.9-3.5 2.13-3.63a4.2 4.2 0 00-3.23-1.94zM14.6 17.5c-.75.3-1.5.7-2.52.7-.95 0-1.54-.37-2.42-.37-.88 0-1.6.4-2.4.4-.8.0-1.55-.37-2.28-.7a5.53 5.53 0 01-1.95-2.2c-1.02-1.9-.3-4.58.97-6.2 1.05-1.33 2.6-2.03 4.1-2.03.78.02 1.7.35 2.47.35.73 0 1.6-.4 2.5-.42.8-.02 2.2.53 3.18 1.9.1.13-1.6 1.1-1.57 3.4.04 2.8 2.2 3.63 2.2 3.63-.84 1.3-1.7 2.3-2.9 2.57z" fill="currentColor"/>
    </svg>
);
